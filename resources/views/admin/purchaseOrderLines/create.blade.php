        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select id="product_id" name="product_id" class="select2" style="width: 100%" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->has('qty')) parsley-error @endif">
                        <input id="qty" type="number" class="form-control col-md-7 col-xs-12"
                               name="qty" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="discount" type="number" class="form-control col-md-7 col-xs-12 @if($errors->has('discount')) parsley-error @endif"
                ...
                {{-- <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name" >
                        {{ __('views.admin.purchase.order.lines.create.name') }}
                        <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
