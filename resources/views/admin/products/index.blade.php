    ...
    <div class="row">
        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
            ...
            <tr>
                ...
                <th>@sortablelink('code', __('views.admin.products.index.table_header_1'),['page' => $products->currentPage()])</th>
                <th>@sortablelink('price', __('views.admin.products.index.table_header_2'),['page' => $products->currentPage()])</th>
                {{-- <th>@sortablelink('deleted_at', __('views.admin.products.index.table_header_3'),['page' => $products->currentPage()])</th> --}}
